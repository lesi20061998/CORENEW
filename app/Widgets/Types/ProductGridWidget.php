...
class ProductGridWidget extends BaseWidget
{
    ...
    {
        return [
            ['key' => 'title',       'label' => 'Tiêu đề section',     'type' => 'text',   'default' => 'Sản phẩm nổi bật'],
            ...
            ['key' => 'columns',     'label' => 'Số cột',               'type' => 'select',
                ...
                'default' => '4'],
            ['key' => 'limit',       'label' => 'Số sản phẩm',         'type' => 'number', 'default' => 8],
            ['key' => 'filter',      'label' => 'Lọc sản phẩm',        'type' => 'select',
                'options' => ['new' => 'Mới nhất', 'sale' => 'Đang giảm giá', 'best_selling' => 'Bán chạy', 'all' => 'Tất cả'],
                'default' => 'new'],
            ['key' => 'category_id', 'label' => 'Danh mục', 'type' => 'category_select', 'default' => []],
            ['key' => 'show_btn',    'label' => 'Hiện nút xem thêm',   'type' => 'toggle', 'default' => true],
            ...
            ['key' => 'tabs',        'label' => 'Tabs lọc',             'type' => 'repeater', 'default' => [],
                'fields' => [
                    ['key' => 'label',       'label' => 'Tên tab',     'type' => 'text'],
                    ['key' => 'category_id', 'label' => 'ID danh mục', 'type' => 'number'],
                    ['key' => 'filter',      'label' => 'Lọc',         'type' => 'select',
                        'options' => ['new' => 'Mới nhất', 'sale' => 'Giảm giá', 'all' => 'Tất cả']],
                ],
            ],
        ];
    }
    ...
    public static function render(array $config, WidgetModel $widget): string
    {
        ...
        return static::view('widgets.types.product_grid', [
            'config'   => $config,
            'widget'   => $widget,
            'products' => $products,
        ]);
