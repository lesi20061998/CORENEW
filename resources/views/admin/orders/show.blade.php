                ...
                <table class="w-full">
                    ...
                    <tfoot class="border-t border-gray-100 bg-gray-50">
                        <tr>
                            ...
                            <td class="tbl-td text-right text-sm font-medium">
                                {{ number_format($order->subtotal, 0, ',', '.') }}₫</td>
                        </tr>
                        @if($order->discount > 0)
                            <tr>
                                <td colspan="3" class="tbl-td text-right text-sm text-green-600">Giảm giá</td>
                                <td class="tbl-td text-right text-sm font-medium text-green-600">
                        ...
                        <tr>
                            ...
                            <td class="tbl-td text-right text-base font-bold text-blue-600">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span
                                            class="text-xs text-gray-400">{{ $history->created_at->format('H:i d/m/Y') }}</span>
